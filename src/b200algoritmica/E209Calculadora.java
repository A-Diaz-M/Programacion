void main(String[] args) {
    ...
    int validacion;
    do {
        double num = Double.parseDouble(IO.readln("Introduzca un numero:\n"));
        int funcion = Integer.parseInt(IO.readln("Introduce \n '1' para sumar              '+'\n '2' para restar             '-'\n '3' para multiplicar        '*'\n '4' para dividir            '/'\n '5' para hacer potencia     '^'\n '6' para hacer Raíz n-ésima '√'\n"));
        double num2 = Double.parseDouble(IO.readln("Introduzca un numero:\n"));
        ...
        IO.println(String.format("El resultado es: %.4f", resultado));
