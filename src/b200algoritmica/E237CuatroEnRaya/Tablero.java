package b200algoritmica.E237CuatroEnRaya;
...
public class Tablero {
    ...
    public static int buscarGanador() {
        ...
        if (matriz[f][0] == jugador && matriz[f][1] == jugador
                && matriz[f][2] == jugador && matriz[f][3] == jugador) {
            return jugador;
        }

        if (matriz[0][c] == jugador && matriz[1][c] == jugador
                && matriz[2][c] == jugador && matriz[3][c] == jugador) {
            return jugador;
        }

        if (f == c) {
            if (matriz[0][0] == jugador && matriz[1][1] == jugador
                    && matriz[2][2] == jugador && matriz[3][3] == jugador) {
                return jugador;
            }
        }

        if (f + c == 3) {
            if (matriz[0][3] == jugador && matriz[1][2] == jugador
                    && matriz[2][1] == jugador && matriz[3][0] == jugador) {
                return jugador;
            }
        }

        if (casillasMarcadas == 16) {
            return 0;
        }
        return -1;
    }
